...
| **2. Documentação de Extração:** fontes escolhidas e métodos de extração | **Concluído** | Detalhado na Seção 1 ("Inventário de Dados") e Seção 2 ("Processamento do Pipeline") do [RELATORIO_ETL.md](file:///c:/Users/joaof/Downloads/Unifacs/analise_dados_big_data/a3/dataset/docs/RELATORIO_ETL.md). |
...
| **5. Documentação de Transformação:** justificativas matemáticas/epidemiológicas | **Concluído** | Justificado detalhadamente nas Seções 3 e 4 do [RELATORIO_ETL.md](file:///c:/Users/joaof/Downloads/Unifacs/analise_dados_big_data/a3/dataset/docs/RELATORIO_ETL.md) (como a estabilização de taxas e exclusão de redundâncias). |
...
| **7. Documentação de Carga:** processos de carga e armazenamento | **Concluído** | Detalhado nas Seções 1.2, 2 e 5 do [RELATORIO_ETL.md](file:///c:/Users/joaof/Downloads/Unifacs/analise_dados_big_data/a3/dataset/docs/RELATORIO_ETL.md). |
...
| **12. Documentação de Padrões:** explicação de como foram obtidos | **Concluído** | Explicado nas notas textuais e comentários do notebook de EDA e nas Seções 2 e 3 do [DICIONARIO_DE_DADOS.md](file:///c:/Users/joaof/Downloads/Unifacs/analise_dados_big_data/a3/dataset/docs/DICIONARIO_DE_DADOS.md). |
